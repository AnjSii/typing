...
public class DiffMatchPatch {
	...
	public DiffMatchPatch(StyledDocument styledDocument) {
	 ...
	 */
	public void diff_pretty(LinkedList<Diff> diffs) {
		...
		for (Diff aDiff : diffs) {
			...
			switch (aDiff.operation) {
				case INSERT:
					try {
						StyleConstants.setBackground(attrset, new Color(255, 200, 200));
						styledDoc.insertString(styledDoc.getLength(), text, attrset);
				...
				case DELETE:
					try {
						StyleConstants.setBackground(attrset, new Color(200, 255, 200));
						styledDoc.insertString(styledDoc.getLength(), text, attrset);
						StyleConstants.setBackground(attrset, Color.white);
					} catch (BadLocationException e) {
						e.printStackTrace();
	...
	public void diffString(String text1, String text2) {
		diff_pretty(diff_main(text1, text2));
	}
	...
	/*public static void main(String[] args) {
		...
		String text2 = "我方在“福州市财政资金补助项目管理系统”的项目实施过程，为保证该haha项目的工程进度、质量，符合目的实施管理规范与要求。";
		System.out.println(dmp.getDiffString(text1, text2));
	}*/
}